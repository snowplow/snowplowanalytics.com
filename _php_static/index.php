    ...
    <link href="assets/css/snowplow-home/home.css" rel="stylesheet" type="text/css">
    </head>
    ...
    <body class="home">
        ...
        <main>
            ...
            <section class="slick no-gutter-vertical" data-slick-fade="1" data-slick-selector=".jumbotron" data-slick-controls=".controls">
                <div class="jumbotron theme-light" style="background-image:url(assets/img/common/hero-1.jpg)">
                    <div class="container">
                        <div class="text">
                            <h1>Empower your team!</h1>
                            <h5>We work with Smart Analysts, Engineers, Scientists and Marketers to enable them to do more with their data.</h5>
                ...
                <div class="jumbotron theme-light" style="background-image:url(assets/img/common/hero-2.jpg)">
                    <div class="container">
                        <div class="text">
                            ...
                            <h5>Track all your interactions with all your users across all channels, including mobile, web, call center, email, ad exchanges, in-store and more.</h5>
                            <a href="#" class="btn btn-primary spacer-top-100">Explore our Case Studies</a>
                        </div>
                    </div>
                </div>
            ...
            <section class="hero no-gutter-vertical" style="background-image: url(assets/img/common/hero-4.jpg)">
                <div class="container text-center well-sm no-border trusties">
                    <h5>Trusted by</h5>
                    <div class="clearfont spacer-40">
