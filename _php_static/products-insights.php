    ...
    <link href="assets/css/snowplow-product-insights/insights.css" rel="stylesheet" type="text/css">
    </head>
    ...
    <body class="insights">
        ...
        <main>
            ...
            <section class="hero theme-light bg-success" style="background-image: url(assets/img/common/bg-symbol.png)">
                <div class="container text-center spacer-30">
                    <h5>Our Products</h5>
                    <h1 class="text-uppercase"><i class="i-logo-type"></i>Insights</h1>
                    <h3>Collect user-level and event-level data across <br/>all platforms and channels.</h3>
                </div>
            </section>
            ...
            <section>
                <div class="container text-center">
                    <h4>Tailor your service and messaging to each of your users, <br/>across all channels and platforms</h4>
            ...
            <section class="jumbotron theme-light no-vertical-gutter height-auto" style="background-image:url(assets/img/common/hero-5.jpg)">
                <div class="container">

                    <div class="well call-to-action">
                        <div class="col col-md-5 no-gutter">
                            <h5 class="text-uppercase no-margin">Interested in Snowplow? Request a demo.</h5>
                        </div>
                        <div class="col col-md-7 no-gutter text-right">
                            <form action="" method="" class="form-inline">
                                <div class="form-group">
                                    <input type="text" class="form-control form-outline-white" placeholder="Your name">
                                    <input type="email" class="form-control form-outline-white" placeholder="Your email">
